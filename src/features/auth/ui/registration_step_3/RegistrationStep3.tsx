...
export function RegistrationStep3({nextStep}: RegistrationStep3Props) {
    let {refFormik, isPending, onSubmit}: UseRegistrationStep3 = useRegistrationStep3(nextStep);
    let initialValues: RegistrationDataStep3 = useAppSelector(select.registration._step3);
        ...
        <div className={s._}>
            ...
            <Formik<RegistrationDataStep3>
                ...
                {(formik: FormikProps<RegistrationDataStep3>) => {
                    let inputError = (key: keyof RegistrationDataStep3) => formik.errors[key] && formik.touched[key]
                        ? formik.errors[key] : null;
                    let selectError = (key: keyof RegistrationDataStep3) => (formik.errors[key] as TSelectOption)?.value && formik.touched[key]
