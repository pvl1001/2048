...
export let initialValuesWithdrawBank: TWithdrawBankValues = {bank: {title: '', value: ''}};
...
export function WithdrawBank() {
    ...
    let bankOptions: TSelectOption[] = useAppSelector(select.withdraw._banks);
    let isPending: boolean = useAppSelector(select.withdraw._isPending);
